...
const projects = [
  {
    ...
    achievements: [
      ...
      'Wrote unit and E2E tests, increasing test coverage to ~85%',
  ...
  },
  {
    ...
    achievements: [
      ...
      'Reduced bundle size and optimized loading behavior',
      'Upgraded Next.js from v11 to v12',
      ...
      'Moved project from deprecated styled-system to tailwind',
    ],
    url: 'https://keeps.com',
  },
  {
    ...
    position: 'Senior Frontend Engineer',
    achievements: [
      'Improved frontend stability by introducing and expanding unit and E2E test coverage',
      'Helped scale the frontend codebase by contributing to monorepo setup and shared tooling',
      'Designed and implemented reusable UI components used across multiple frontend applications',
      'Reduced page load times by optimizing GraphQL queries, pagination, and rendering logic',
                  ...
                  >
                    <ValuePropCard>
                      <div className="space-y-4">
                        ...
                        <Typography className="text-primary md:text-lg">
                          {project.position}
                        </Typography>
