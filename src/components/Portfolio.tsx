          ...
          {skills.map((skill, index) => (
            ...
            >
              <div className="relative p-6 md:p-8 border-2 border-purple-500/30 bg-black hover:border-purple-500 transition-all duration-300 min-h-[180px] md:min-h-[200px] flex flex-col">
                {/* Corner accents */}
                <div className="absolute -top-1 -left-1 w-3 md:w-4 h-3 md:h-4 bg-purple-500 opacity-0 group-hover:opacity-100 transition-opacity" />
                <div className="absolute -bottom-1 -right-1 w-3 md:w-4 h-3 md:h-4 bg-fuchsia-500 opacity-0 group-hover:opacity-100 transition-opacity" />
